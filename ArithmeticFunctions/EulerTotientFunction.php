...
body {
  ...
  <body>
    ...
    <section>
    <div class="container">
    <h1>Euler Totient Function Calculator</h1>
    <h4>This calculator helps for calculating the Euler Totient Function of an arbitrary precision number.
    ...
    <div>
      <button onclick="calculateTotient()">Calculate</button>
  ...
  <script>
    function calculateTotient() {
      ...
      var totient = calculateEulerTotient(number);
      displayTotient(totient);
    }

    function calculateEulerTotient(number) {
      var count = 0;
    ...
    function displayTotient(totient) {
      var resultOutput = document.getElementById("result");

      resultOutput.innerHTML = "";
      resultOutput.appendChild(document.createTextNode("Euler Totient Function:"));
      resultOutput.appendChild(document.createElement("br"));
      resultOutput.appendChild(document.createTextNode("φ(n) = " + totient));
    }
