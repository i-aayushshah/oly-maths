...
body {
  ...
  <body>
    ...
    <div class="container">
    <h1>Mobius Function Calculator</h1>
    <h4>This calculates the value of the Mobius function μ(n) of a positive integer n.</h4>
    <div>
      <label for="number">Enter the number, n:</label>
      <input type="number" id="number" placeholder="Enter a positive integer">
    </div>
    <div>
      <button onclick="calculateMobius()">Calculate</button>
  ...
  <script>
    function calculateMobius() {
      ...
      var mobius = calculateMobiusFunction(number);

      resultOutput.textContent = "μ(" + number + ") = " + mobius;
    }

    function calculateMobiusFunction(n) {
      var factorCount = 0;
      var isSquareFree = true;
    ...
    // Execute calculateMobius function when Enter key is pressed
