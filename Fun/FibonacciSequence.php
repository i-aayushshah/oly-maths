...
body {
  ...
  <body>
    ...
    <h4>This interface is provided for generating the Fibonacci sequence.</h4>
    <div>
      <label for="fibonacci-number">Generate up to the the entered terms: </label>
      <input type="number" id="fibonacci-number" min="1">
      <button onclick="generateFibonacciSequence()">Generate</button>
      <button onclick="clearOutput()" class="btn-clear">Clear</button>
    </div>
  ...
  <script>
    function generateFibonacciSequence() {
      ...
      var output = "<strong>Fibonacci Sequence:</strong><br>";
