...
body {
  ...
  <body>
    ...
    <h4>This returns the complete prime factorization of a number.</h4>
    <div>
      <label for="number">Enter a number:</label>
      <input type="number" id="number" min="1" onkeydown="handleEnterKey(event)">
    </div>
    <div>
      <button onclick="calculatePrimeFactors()">Calculate</button>
  ...
  <script>
    function calculatePrimeFactors() {
      ...
      resultOutput.textContent = "Prime Factorization: " + primeFactors.join(" × ");
    }
