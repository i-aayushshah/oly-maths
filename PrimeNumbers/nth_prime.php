...
body {
  ...
  <body>
    ...
    <div class="container">
    <h1>Nth Prime Calculator</h1>
    <h4>This returns the nth prime number.</h4>
    <div>
      <label for="nth-number">Enter the value of n:</label>
      <input type="number" id="nth-number" min="1" onkeydown="handleEnterKey(event)">
    </div>
    <div>
  ...
  <script>
    function calculateNthPrime() {
      var nthInput = document.getElementById("nth-number");
      var resultOutput = document.getElementById("result");

      var n = parseInt(nthInput.value);
      ...
      var prime = findNthPrime(n);

      resultOutput.textContent = "The " + n + "th prime number is: " + prime;
    }
    ...
    function findNthPrime(n) {
      ...
      while (primes.length < n) {
        ...
        currentNumber += 2; // Optimization: Check only odd numbers
      }
