...
body {
  ...
  <body>
    ...
    <section>
    <div class="container">
    <h1>Prime Count Calculator -- π(n)</h1>
    <h4>It will return the number of primes less than or equal to a specified number.</h4>
    <div>
      <label for="number">Enter a number:</label>
      <input type="number" id="number" min="1" onkeydown="handleEnterKey(event)">
    </div>
    <div>
      <button onclick="calculatePrimeCount()">Calculate</button>
  ...
  <script>
    function calculatePrimeCount() {
      ...
      var primeCount = getPrimeCount(number);

      resultOutput.textContent = "Number of Primes: " + primeCount;
    }

    function getPrimeCount(number) {
      var primes = [];
      var count = 0;
