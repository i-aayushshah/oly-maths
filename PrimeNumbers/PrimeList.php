...
body {
  ...
  <body>
    ...
    <h4>This generates a list of prime numbers within a specified range.</h4>
    <div>
    ...
    <div>
      <button onclick="generatePrimeList()">Generate List</button>
  ...
  <script>
    function generatePrimeList() {
      ...
      var primeList = getPrimeList(start, end);

      resultOutput.textContent = primeList.join(", ");
    }

    function getPrimeList(start, end) {
      var primes = [];
