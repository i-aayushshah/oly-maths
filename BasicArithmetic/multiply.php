...
body {
  ...
  <body>
    ...
    <div>
      <label for="numbers">Enter two or more numbers (separated by commas):</label>
      <input type="text" id="numbers" onkeydown="handleEnterKey(event)">
    </div>
    <div>
      <label for="decimal-places">Number of decimal places (max. 100):</label>
  ...
  <script>
    function multiplyNumbers() {
      ...
      resultOutput.textContent = "Multiplied result: " + result.toFixed(decimalPlaces);
    }
