...
body {
  ...
  <body>
    ...
    <h1>Division</h1>
    <div>
      <label for="numbers">Enter two numbers separated by commas (Numerator and Denominator):</label>
      <input type="text" id="numbers" onkeydown="handleEnterKey(event)">
    </div>
    <div>
      <label for="decimal-places">Enter number of decimal places (max. 15):</label>
  ...
  <script>
    function divideNumbers() {
      ...
      var numerator = parseFloat(inputValues[0]);
      var denominator = parseFloat(inputValues[1]);
