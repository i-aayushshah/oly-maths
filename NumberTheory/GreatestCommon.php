...
body {
  ...
  <body>
    ...
    <section>
    <div class="container">
    <h1>Greatest Common Division (GCD)</h1>
    <h4>This returns the Greatest Common Divisor(GCD) or Highest Common Factor(HCF) of a set of numbers of arbitrary precision.</h4>
    <div>
      <label for="numbers">Enter two or more positive integers separated by commas:</label>
  ...
  <script>
    function calculateGCD() {
      ...
      for (var i = 0; i < inputValues.length; i++) {
        var number = parseInt(inputValues[i]);
      ...
      var gcd = calculateGreatestCommonDivisor(numbers);
      resultOutput.textContent = "The GCD of " + numbers.join(", ") + " is: " + gcd;
    }

    function calculateGreatestCommonDivisor(numbers) {
      var gcd = numbers[0];
