...
body {
  ...
  <body>
    ...
    <section>
    <div class="container">
    <h1>Lowest Common Multiple (LCM)</h1>
    <h4>This returns the Lowest Common Multiple(LCM) of a set of numbers of arbitrary precision.</h4>
    <div>
  ...
  <script>
    function calculateLCM() {
      ...
      var lcm = calculateLeastCommonMultiple(numbers);
      resultOutput.textContent = "The LCM of " + numbers.join(", ") + " is: " + lcm;
    }
